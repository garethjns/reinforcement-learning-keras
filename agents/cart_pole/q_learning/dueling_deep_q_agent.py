...
class DuelingDeepQAgent(DeepQAgent):
    ...
    def _build_model_copy(self, model_name: str) -> keras.Model:
        ...
        a_layer = keras.layers.Dense(self._env.action_space.n, activation='linear')(fc2)
        ...
        output = keras.layers.Lambda(_merge_layer, output_shape=(self._env.action_space.n,),
